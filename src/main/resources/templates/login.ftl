...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><span>${error!}</span></p>
    <form id="form1" method="post" action="/admin/login">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="username" placeholder="username" value="" id="username" required>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" id="btn-submit" class="btn btn-primary float-right">登 录</button>
        </div>
        <!-- /.col -->
      </div>
    </form>

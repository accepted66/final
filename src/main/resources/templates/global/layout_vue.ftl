...
<head>
    ...
    <!--vue+ iview-->
    <link rel="stylesheet" href="${urls.getForLookupPath("/css/iview.css")}">
    <script type="text/javascript" src="${urls.getForLookupPath("/js/iview/vue.min.js")}"></script>
    <script type="text/javascript" src="${urls.getForLookupPath("/js/iview/iview.min.js")}"></script>
    <!-- CDNJS :: Vue.Draggable (https://cdnjs.com/) -->
<#--    <script src="//cdnjs.cloudflare.com/ajax/libs/Vue.Draggable/2.20.0/vuedraggable.umd.min.js"></script>-->
    <script src="${urls.getForLookupPath("/js/iview/axios.min.js")}"></script>
</head>
<style>
    .ivu-table .table-hidden-row td {
        /*background-color: #f2f2f2;*/
        color: #c8ccd0;
    }

    .ivu-table .table-period-row td {
...
<#--<script src="${urls.getForLookupPath("https://cdnjs.cloudflare.com/ajax/libs/Sortable/1.10.2/Sortable.min.js")}"></script>-->
<!-- aidata360.common.js.hidden -->
<script src="${urls.getForLookupPath("/js/global/common.js")}"></script>
<script src="${urls.getForLookupPath("/js/global/bee.js")}"></script>
<script src="${urls.getForLookupPath("/js/global/BigDecimal-all-last.min.js")}"></script>
